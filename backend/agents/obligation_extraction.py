...
SYSTEM_PROMPT = (
    ...
    "definitions, preambles, recitals, enabling-power citations, commencement/effective-date "
    "clauses ('come into force', 'with immediate effect') and descriptive statements.\n\n"
    "FIELDS:\n"
